...
from customer.serializers import UserSerializer, CustomerSerializer, AdminSerializer
...
class LoginSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        if self.user.role == "customer":
            customer_data = CustomerSerializer(Customer.objects.get(user=self.user)).data
